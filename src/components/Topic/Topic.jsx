  ...
  return (
    ...
    <div className="max-w-xs rounded-md shadow-md bg-gray-900 text-gray-100">
      ...
      <div className="flex justify-center p-3 items-center">
        ...
        <button type="button" className="flex items-center justify-center w-26 p-3 font-semibold tracking-wide rounded-md bg-violet-400 text-gray-900">Start Practice</button>
      </div>
    </div>
        </div>
  );
